...
// карточки «оптом/розница» и «доставка», FAQ-аккордеон и CTA.
// Тексты и ссылки сохранены полностью — менялась только вёрстка.
// =========================================================
...
const FACTS = [
  ...
  },
  {
    icon: Percent,
    title: "Опт от 50 шт.",
    text: "специальные цены для оптовых клиентов",
  },
  {
    icon: Layers,
    title: "3- и 5-слойный",
        ...
        <div className="seo-home__inner">
          ...
          <header className="seo-home__head">
            ...
            <p className="seo-home__intro">
              ...
              У нас можно купить картонные коробки оптом и в розницу,
              гофрокоробки и упаковочные материалы со склада на ул. Ватутина.
              Работаем с физическими и юридическими лицами, доставляем по
              городу и области.
            </p>
          </header>
          ...
          <div className="seo-home__grid">
            ...
            <div className="seo-home__panel">
              ...
              <div className="seo-home__more">
                <Link href="/gofrotara">Гофротара оптом</Link>
          ...
          <div className="seo-home__cards">
            <article className="seo-home__card">
              <h3 className="seo-home__h3">
                Купить картонные коробки — оптом и в розницу
              </h3>
              <p className="seo-home__p">
                Если вам нужны{" "}
                ...
                коробок минимальный заказ — 1 шт., оптовая цена действует от 50
                шт. Нестандартные размеры и 3- или 5-слойные коробки{" "}
